      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          {stats.map((stat, i) => (
            <div
              key={stat.label}
              className="relative group rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6 text-center hover:border-primary-500/20 hover:bg-primary-600/5 transition-all duration-300"
            >
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {[
            ...
            <motion.div
              ...
              className="group relative rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6 hover:border-primary-500/20 hover:bg-primary-600/5 transition-all duration-300"
            >
